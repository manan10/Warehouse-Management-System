			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
			  		<ul class="nav navbar-nav navbar-right">
						<li><a href="admin.php" target="_parent">Dashboard</a></li>
			...
			<div class="container-fluid">
				...
				<div class="container col-md-2 col-lg-2 bor" style="color: black;border-radius: 2px;">
					...
					<ul class="nav nav-pills nav-stacked" id="el" style="text-align:left">
						<li><a style="font-size: 20px;" href="../../php/data/man_list.php" target="frame">Manager List</a></li>
						<li><a style="font-size: 20px;" href="../../php/data/user_list.php" target="frame">User List</a></li>
						<li><a style="font-size: 20px;" href="add_man.html" target="frame">Add Manager</a></li>
						<li><a style="font-size: 20px;" href="add_user.html" target="frame">Add User</a></li>
						<li><a style="font-size: 20px;" href="rem_man.html" target="frame">Remove Manager</a></li>
						<li><a style="font-size: 20px;" href="rem_user.html" target="frame">Remove User</a></li>
					</ul>
				</div>
				<div class="col-md-10 col-lg-10">
				<iframe height="100%" width="100%" name="frame" style="background-color: white;" src="../../php/a-frame.php"></iframe>
			</div>	
		</div>
		</center>
	</body>	
